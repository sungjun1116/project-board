...
class PaginationServiceTest {
    ...
    public PaginationServiceTest(@Autowired final PaginationService sut) {
        this.sut = sut;
    }
    ...
    void givenCurrentPageNumberAndTotalPages_whenCalculating_thenReturnsPaginationBarNumbers(
        ...
        assertThat(sut.getPaginationBarNumbers(currentPageNumber, totalPages)).isEqualTo(expected);
    }
    ...
    void givenNoting_whenCalling_thenReturnsCurrentBarLength() {
        assertThat(sut.currentBarLength()).isEqualTo(5);
    }
